...
/**
 * A <code>MetaMessage</code> is a <code> MidiMessage</code> that is not meaningful to synthesizers, but
 ...
 * a <code> ShortMessage</code> with the status value <code>0xFF</code> represents
...
public class MetaMessage extends MidiMessage {
     ...
     *  #setMessage(int, byte[], int) setMessage
     ...
     * it does not need to be specified here.  Calls to <code> MidiMessage#getStatus getStatus</code> return
