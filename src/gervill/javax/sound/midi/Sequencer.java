 ...
 * <code> Sequence sequence</code> is known as a <em>sequencer</em>.
...
public interface Sequencer extends MidiDevice {
     ...
     * The Sequencer starts running when either <code> #start</code> or <code> #startRecording</code>
     ...
     * The Sequencer begins recording when <code> #startRecording</code> is called,
     * and then returns <code>true</code> until <code> #stop</code> or <code> #stopRecording</code>
     * is called.
     ...
     * <code> #getTempoInMPQ</code> and <code> #getTempoInBPM</code>.
     ...
     * follow this call with a call to <code> #getTrackMute</code>.
     *
     ...
     * for the current sequence, or the sequencer may not support this functionality.
     * An application which needs to verify whether this operation succeeded should
     * follow this call with a call to <code> #getTrackSolo</code>.
     *
     * @param track the track number.  Tracks in the current sequence are numbered
     * from 0 to the number of tracks in the sequence minus 1.
