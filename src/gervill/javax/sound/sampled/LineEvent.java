 ...
 *  LineListener#update update method.  By querying the event,
...
public class LineEvent extends java.util.EventObject {
     ...
     * @return this event's type ( Type#OPEN,  Type#CLOSE,
    ...
    public static class Type {
         ...
         * of audio data in response to a  DataLine#stop stop request,
