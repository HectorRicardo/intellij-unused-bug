 ...
 * speaker, headphone, and line output.  You can access port using a <code> Port.Info</code>
 * object.
 *
 * @author Kara Kytle
 * @since 1.3
...
public interface Port extends Line {
    ...
    /**
     * The <code>Port.Info</code> class extends <code> Line.Info</code>
     ...
     * <code> Mixer#getSourceLineInfo getSourceLineInfo</code> and
     * <code> Mixer#getTargetLineInfo getTargetLineInfo</code>
