...
public abstract class MixerProvider {
     ...
     * see #getMixer(gervill.javax.sound.sampled.Mixer.Info) getMixer(Mixer.Info)
     * see #isMixerSupported(gervill.javax.sound.sampled.Mixer.Info) isMixerSupported(Mixer.Info)
     */
