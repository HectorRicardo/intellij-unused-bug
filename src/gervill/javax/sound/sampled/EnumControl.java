 ...
 * of the sort that would be represented by <code> FloatControl</code>
 * objects.
 * <p>
 * Controls that provide a choice between only two settings can often be implemented
 * instead as a <code> BooleanControl</code>, and controls that provide
 ...
 * of a <code> EnumControl.Type#REVERB REVERB</code> control are instances of
 * <code> ReverbType</code> that can be queried for the parameter values
...
public abstract class EnumControl extends Control {
    ...
    public static class Type extends Control.Type {
         ...
         * invoke <code> EnumControl#getValues</code> on an
